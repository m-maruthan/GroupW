...
<div class="wpb_row pix-row vc_row-fluid light normal"><div class="bg-pos-rel"><div class="pix-con clearfix">
    ...
    border-radius: 15px;">Save</button>
						...
						<div class="col-md-4">
							<button type="button" class="btn btn-danger" style="    border: 2px solid red;padding: 8px;border-radius: 15px;">Publish</button>
						</div>
					</div>
				</div>
             ...
             <div class="col-md-12">
              ...
              <div class="col-md-12">
	                <div class="col-md-6">
	                	...
	                	<div class="col-md-6">
	                		<input id="author" name="author" class="textArea" type="text" value="" size="30" placeholder="Event Title" aria-required="true">
	                	</div>
	                </div>
	                <div class="col-md-6">
               ...
               <div class="col-md-12">
	                <div class="col-md-6">
	                	...
	                	<div class="col-md-6">
	                		<select id="author" name="author" class="textArea"  value="" placeholder="Location" aria-required="true">
               ...
               <div class="col-md-12">
                ...
                <div class="col-md-12" style="margin-bottom: 25px;">
	                <div class="col-md-6">
	                	...
	                	<div class="col-md-6">
	                		<input id="author" name="author" class="textArea" type="text" value="" size="30" placeholder="Organizer Name" aria-required="true">
	                	</div>
	                </div>
	                <div class="col-md-6">
                 ...
                 <table class="table table-bordered">
				    ...
				    <tbody>
				      <tr>
				         <th>Early Bird</th>
				        <td>
				        	<input id="author" name="author" class="textArea" type="text" value=""  placeholder="100" aria-required="true">
				        </td>
				        <td>
				        	<input id="author" name="author" class="textArea" type="text" value=""  placeholder="10.00" aria-required="true">
				        </td>
             ...
             <div class="col-md-12">
                ...
                <div class="col-md-6">
                	<div class="col-md-2">
                		<input type="radio" value="policy" name="policy">
