...
<li id="menu-item-119" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-119 pix-submenu external"><a href="#">CREATE EVENT</a></li>
	...
	<!-- <div class="vc_col-sm-12 wpb_column vc_column_container ">
		<div class="wpb_wrapper">
			<h2 class="main-title title sub-title-con   size-lg alignCenter" style="font-weight: 300; ">Get Ready for The Next Event. Its Beginning!</h2><p class="sub-title " >Authoritatively repurpose cross-media technologies rather than front-end communities. Efficiently implement professional schema after diverse results.</p><div class="center-clock"><div class="countdown countdown-container container">
            <div class="clock clearfix" data-eventtimer="" data-color="#c4cbcf">
        ...
        </div></div> <div class="spacer" style="height: 30px"></div>
		</div> 
	</div>  -->
