...
<section class="sub-banner newsection">
	    <div class="container">
	        <h2 class="title">Search Events</h2><ul class="breadcrumb" itemprop="breadcrumb"><li><a href="#">Home</a> </li><li><span class="current" >Search Events</span></li></ul></div>
	</section>
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg" style="padding: 20px;"><img src="image/ev1.jpeg"  alt=""></div>
        <div class="entry-content cf event-content">
           <h2 class="title"><a href="#" title="Professionally build market positioning materials">Russell Peters:<br>
                Every Race Has its Day</a></h2>

           <ul class="meta clearfix">
				<li>
					<i class="icon fa fa-clock-o"></i>27th November 2017 @ 18:00
				</li>
		       <!--  <li>
            ...
            <p class="author">
            	...
            	Wembley Stadium
                 <p>14 Exhibition Road, London, HA6 3TA </p>
				                                    	</p>
               ...
               <br>
                ...
                <br>
			 	...
			 	<div class="col-md-8" style="border: 1px solid black; height: 100px;">
			 		<h3>Discription of the event.</h3>
			 	</div>
			 	</div>
			 	<br>
               <div class="container-fluid">
