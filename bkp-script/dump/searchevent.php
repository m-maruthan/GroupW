    ...
    <div class="event clearfix bg">
        ...
        <div class="entry-content cf event-content">
           <h2 class="title"><a href="#" title = "Sysmatically Empower Inexpensive Infomation">Sysmatically Empower Inexpensive Infomation</a></h2>
            ...
            <!-- <a href="#" class="btn btn-solid btn-blue btn-md">Buy Ticket</a> -->
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev3.jpg" style="height: 250px;"  alt=""></div>
        ...
        <div class="entry-content cf event-content">
           <h2 class="title"><a href="#" title = "Sysmatically Empower Inexpensive Infomation">Sysmatically Empower Inexpensive Infomation</a></h2>
            ...
            <a href="#" class="btn btn-solid btn-blue btn-md">Buy Ticket</a><br>
            <a href="#" class="btn btn-border btn-grey btn-md">Read More</a>
        </div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev4.jpg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev5.jpg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev6.jpg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev7.jpg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev8.jpg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/ev1.jpeg" style="height: 250px;"  alt=""></div>
...
<div id="post-9" class="col-md-4" role="article" style="border-bottom: 1px solid #e6e6e6;">
    ...
    <div class="event clearfix bg">
        ...
        <div class="eventsimg"><img src="image/LiveEvents1.jpg" style="height: 250px;"  alt=""></div>
        ...
        <div class="three links clearfix">
               ...
               <div class="col-md-3">
                 <aside id="aside" class="clearfix no-border-bottom" style="margin-top: 15px;">

                            <div class="header">
                                <small>Hottest Shows </small>
                                <h2 class="title">Coming Soon!</h2>
                                <span class="arrow-down"></span>
                            </div>
                           <div class="event bg" style="border-bottom: 1px solid #e6e6e6;">
                            		<div class="eventsimg"><img src="image/liveevent3.jpg" style="height: 220px;" alt=""></div>
                            		<div class="event-content">
                                	<h3 class="title">Globally Synthesize Growth Strategy</h3><p>Appropriately harness team driven data for proactive ideas. Dynamically customize backend quality vectors whereas impactful networks. Uniquely innovate virtual meta-services vis-a-vis orthogonal... [...] </p><a href="#" class="btn btn-solid btn-blue btn-md">Buy Ticket</a>
                                	<a href="#" class="btn btn-border btn-grey btn-md">Read More</a>
                                </div><div class="links three clearfix">
					                    <ul>
					                    	<li><a class="st_sharethis_large" displaytext="ShareThis" st_processed="yes"><i class="icon fa fa-share"></i> share<span style="text-decoration:none;color:#000000;display:inline-block;cursor:pointer;" class="stButton"><span class="stLarge" style="background-image: url(&quot;http://w.sharethis.com/images/sharethis_32.png&quot;);"></span></span></a></li>
                                     ...
                                     <br>
					               	 ...
					               	 <div class="event bg" style="border-bottom: 1px solid #e6e6e6;">
                            		<div class="eventsimg"><img src="image/liveevent4.jpg" style="height: 220px;" alt=""></div>
                            		<div class="event-content">
                                	<h3 class="title">Globally Synthesize Growth Strategy</h3><p>Appropriately harness team driven data for proactive ideas. Dynamically customize backend quality vectors whereas impactful networks. Uniquely innovate virtual meta-services vis-a-vis orthogonal... [...] </p><a href="#" class="btn btn-solid btn-blue btn-md">Buy Ticket</a>
                                   <a href="#" class="btn btn-border btn-grey btn-md">Read More</a>
                                </div><div class="links three clearfix">
