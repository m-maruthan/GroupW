...
<li id="menu-item-119" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-119 pix-submenu external"><a href="#">CREATE EVENT</a></li>
      ...
      <!-- HEADER -->  <section class="sub-banner newsection">
	    <div class="container">
	        <h2 class="title">Contact Us</h2><ul class="breadcrumb" itemprop="breadcrumb"><li><a href="http://innwithemes.com/eventonwp">Home</a> </li><li><span class="current" >Contact Us</span></li></div>
	</section>
    ...
    <div class="col-sm-12" id="parent">
    	...
    	<div class="col-sm-6">
    		<form action="form.php" class="contact-form" method="post">
		      ...
		      <br>
	      	  <button class="btn btn-primery btn-send"> <span class="fa fa-paper-plane"></span> Send </button>
		      </div>
     		</form>
    	</div>
    	<div class="col-sm-6">
