...
$sql ="SELECT * FROM `users_register` WHERE user_id = $id";
	...
	<body class="home page page-id-21 page-template-default wpb-js-composer js-comp-ver-4.4.2 vc_responsive">
         ...
         <header class="header-container">
          ...
          <?php
               if(isset($_GET['yes']))
              {  // print_r($_GET);die;
              echo '<div class="alert alert-success alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              ...
              {  // print_r($_GET);die;
              echo '<div class="alert alert-success alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                "You Have successfully Log out" </div>';  
                         
               }
              if(isset($_GET['er1']))
              {  // print_r($_GET);die;
              echo '<div class="alert alert-danger alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              ...
              {  // print_r($_GET);die;
              echo '<div class="alert alert-danger alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                "Both Email and Password is required" </div>';  
                         
               }
                if(isset($_GET['er4']))
              {  // print_r($_GET);die;
              echo '<div class="alert alert-danger alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                "Incorrect email and password combination" </div>';  
            ...
            if(isset($_GET['error']))
              {  // print_r($_GET);die;
              echo '<div class="alert alert-danger alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                "Email is already exist ! Try another " </div>';  
              ...
              // echo '<div class="alert alert-success alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              //   You Have successfully log in !  Welcome '.$rows['first_name'];'</div>' ; 
              ...
              {  // print_r($_GET);die;
              echo '<div class="alert alert-success alert-dismissable fade in" role="alert"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                "New event successfully added !" </div>';  
                         ...
                         <!--   <div id="sb-search" class="sb-search">
                          ...
                          <nav  class="main-nav mobile-menu" role="navigation">
                             <ul id="menu-main-menu" class="nav top-nav cf">
                                ...
                                <li id="menu-item-46" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-46 pix-submenu external"><a href="about.php">ABOUT US</a></li>
                                ...
                                <li id="menu-item-212" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-212 pix-submenu external"><a href="faq.php">FAQ</a></li>
                                  ...
                                  {
                                     ?>
                                     <li id="menu-item-185" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-185 pix-submenu external"><a href="feedback.php">FEEDBACK</a></li>
                                     <li id="menu-item-119" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-119 pix-submenu external"><a href="createevent.php">CREATE EVENT</a></li>
                                  ...
                                  <ul style="display: none;" class="sub-menu">
                                    ...
                                    <li id="menu-item-273" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-273 external"><a href="logout.php">logOut</a></li>
